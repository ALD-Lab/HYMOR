...
Plots both the upstream freestream disturbance pattern and the resulting perturbation field inside the shock layer at time `T_plot`. Setting `freestream_disturbances = true` activates the freestream component of the visualization. It can be seen that the initial optimal disturbance is placed in the entropy-shear layer to exploit mechanisms of the entropy-shear layer generated by shock curvature. This disturbance excites a growth mechanism that propagates across the entropy layer, while it interacts with the shock-wave.

<table>
<tr>
<td align="center"><img src="figures/freestream_receptivity_initial_pressure_cropped.png" width="400"><br><b>Figure 4.a)</b> Initial freestream pressure of optimal disturbance, at <code>T_TGF = 5</code>, <code>T_plot = 0.0</code>, <code>mode = 1</code>, <code>time_optimization_index = 1</code>.</td>
<td align="center"><img src="figures/freestream_receptivity_entropy_cropped.png" width="400"><br><b>Figure 4.b)</b> Pressure of optimal disturbance, at <code>T_TGF = 5</code>, <code>T_plot = 5</code>, <code>mode = 1</code>, <code>time_optimization_index = 1</code>.</td>
</tr>
<tr>
<td align="center"><img src="figures/freestream_receptivity_vort_cropped.png" width="400"><br><b>Figure 4.c)</b> Vorticity of optimal disturbance, at <code>T_TGF = 5</code>, <code>T_plot = 5</code>, <code>mode = 1</code>, <code>time_optimization_index = 1</code>.</td>
<td></td>
</tr>
</table>
